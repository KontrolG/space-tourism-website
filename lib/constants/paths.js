...
export const TECHNOLOGY_IMAGES_PATH = IMAGES_PATH + "/technology";
...
export const TECHNOLOGY_ROOT_PATH = "/technology";
export const getTechnologyPath = (technologyId) =>
  `${TECHNOLOGY_ROOT_PATH}/${technologyId}`;
